#!/usr/bin/env python3
"""Network-free Profile smoke runner for the full NanoClaudeCode example."""
...
from app.profile_policy import InteractiveProfilePolicy
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Run NanoClaudeCode without a provider")
