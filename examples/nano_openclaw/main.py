#!/usr/bin/env python3
"""Independently runnable deterministic NanoOpenClaw example."""
...
from app.policy import GatewayPolicy, contribute_gateway_tools
...
def run_demo(root: Path):
    return run_profile_scenario(
        ...
        contribute_tools=contribute_gateway_tools,
    )


def main(argv=None):
    parser = argparse.ArgumentParser(description="Run the NanoOpenClaw smoke harness")
